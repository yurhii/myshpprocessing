...
class MapWareCore{
	...
	function createProcessingTables(){
		...
		$query = "CREATE TABLE `imagenes` (
		  ...
		  `mapa_exists` enum('0','1', '2') NOT NULL,
		  `satelite_exists` enum('0','1','2') NOT NULL,
		  `hibrido_exists` enum('0','1', '2') NOT NULL,
		  ...
		  KEY `drawing_processing_key` (`nivel`, `cpu`, `aDibujar`),
		  KEY `hibrido_processing_key` (  `nivel` ,  `mapa_exists` ,  `hibrido_exists` ,  `cpu` ),
